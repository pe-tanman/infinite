...
import MFADebugger from '@/components/auth/MFADebugger'
import RecaptchaDebugger from '@/components/auth/RecaptchaDebugger'
...
const SettingsPage: React.FC = () => {
    ...
    const tabs = [
        ...
        { id: 'cache', label: 'Storage', icon: '💾' },
        { id: 'debug', label: 'MFA Debug', icon: '🔧' },
    ]
                        ...
                        <div className="p-0">
                            ...
                            {activeTab === 'debug' && (
                                <div className="p-0">
                                    <div className="border-b border-gray-200">
                                        <div className="p-6">
                                            <h3 className="text-lg font-semibold text-gray-900 mb-4">🔧 MFA & reCAPTCHA Debugging</h3>
                                            <p className="text-gray-600 mb-4">Use these tools to diagnose and troubleshoot MFA and reCAPTCHA issues.</p>
                                        </div>
                                    </div>
                                    <MFADebugger />
